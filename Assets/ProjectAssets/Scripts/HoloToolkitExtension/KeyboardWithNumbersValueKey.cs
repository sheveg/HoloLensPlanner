...
namespace HoloLensPlanner
{
    ...
    public class KeyboardWithNumbersValueKey : MonoBehaviour
    {
        /// <summary>
        ...
        private void Start()
        {
            ...
            KeyboardWithNumbers.Instance.OnKeyboardShifted += Shift;
        }
        ...
        {
            KeyboardWithNumbers.Instance.AppendValue(this);
        }
