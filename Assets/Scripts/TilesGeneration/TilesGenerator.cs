        ...
        private void updateSpawnPoint()
        {
            ...
            if ((newSpawnPoint = getNearestPoint()) != null)
            {
                ...
                if (newSpawnPoint != m_CurrentSpawnPoint)
                {
                    if (m_CurrentSpawnPoint != null)
                    {
                        var oldPolyPointGazeScaler = m_CurrentSpawnPoint.GetComponent<GazeScaler>();
                        if (oldPolyPointGazeScaler)
                        {
                            oldPolyPointGazeScaler.ForceOnFocusExit();
                        }
                    }
                    m_CurrentSpawnPoint = newSpawnPoint;
                    var polyPointGazeScaler = m_CurrentSpawnPoint.GetComponent<GazeScaler>();
                    if (polyPointGazeScaler)
                    {
                        polyPointGazeScaler.ForceOnFocusEnter();
                    }
                }
            }
        }
        ...
        private void updateDirectionPoint()
        {
            ...
            if ((newDirectionPoint = getNearestPoint(m_CurrentSpawnPoint)) != null)
            {
                ...
                if (newDirectionPoint != m_CurrentDirectionPoint)
                {
                    if (m_CurrentDirectionPoint != null)
                    {
                        var oldPolyPointGazeScaler = m_CurrentDirectionPoint.GetComponent<GazeScaler>();
                        if (oldPolyPointGazeScaler)
                        {
                            oldPolyPointGazeScaler.ForceOnFocusExit();
                        }
                    ...
                    var polyPointGazeScaler = m_CurrentDirectionPoint.GetComponent<GazeScaler>();
                    if (polyPointGazeScaler)
                    {
                        polyPointGazeScaler.ForceOnFocusEnter();
                    }
