...
{
    /// <summary>
    /// A simple general use keyboard that is ideal for AR/VR applications. Exension for number keyboard.
    /// </summary>
    /// 
    ...
    public class KeyboardWithNumbers : Singleton<KeyboardWithNumbers>
    {
        ...
        private Transform m_TargetFollow = null;
        ...
        public void AppendValue(KeyboardWithNumbersValueKey valueKey)
        {
            string value = "";
        ...
        public void FunctionKey(KeyboardWithNumbersKeyFunc functionKey)
        {
            switch (functionKey.m_ButtonFunction)
            {
                case KeyboardWithNumbersKeyFunc.Function.Enter:
                    {
                        Enter();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Tab:
                    {
                        Tab();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.ABC:
                    {
                        ActivateSpecificKeyboard(m_LastKeyboardLayout);
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Symbol:
                    {
                        ActivateSpecificKeyboard(LayoutType.Symbol);
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Previous:
                    {
                        MoveCaretLeft();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Next:
                    {
                        MoveCaretRight();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Close:
                    {
                        Close();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Dictate:
                    {
#if UNITY_WSA || UNITY_STANDALONE_WIN
                ...
                case KeyboardWithNumbersKeyFunc.Function.Shift:
                    {
                        Shift(!m_IsShifted);
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.CapsLock:
                    {
                        CapsLock(!m_IsCapslocked);
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Space:
                    {
                        Space();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.Backspace:
                    {
                        Backspace();
                        break;
                    }

                case KeyboardWithNumbersKeyFunc.Function.UNDEFINED:
                    {
